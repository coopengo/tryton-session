...
Session.prototype.rpc = function (method, params, context, forceContext) {
  if (forceContext) {
    ...
    return rpc(this, method, params, _.extendOwn(this.context, context));
  }
};
Session.prototype.bulk = function (method, params, context, forceContext) {
  if (forceContext) {
    ...
    return rpc.bulk(this, method, params, _.extendOwn(this.context, context));
  }
};
//
...
Session.prototype.listLang = function () {
  return rpc(this, methods.listLang, [], null, {
    nodb: true,
    anonymous: true
  });
};
